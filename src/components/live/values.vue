  ...
  <div class="values u-margin-bottom-medium">
    <transition name="fade">
      <p class="value">
        ...
        <span class="tag tag--temperature">Temperatura</span>
      </p>
    </transition>
    <transition name="fade">
      <p class="value">
        <span class="number">{{ data.humidity + "%" }}</span>
        <span class="tag tag--humidity">Umidità</span>
      </p>
    </transition>
    <transition name="fade">
      <p class="value">
        <span class="number">{{ data.pressure + "hPa" }}</span>
        <span class="tag tag--pressure">Pressione</span>
      </p>
    </transition>
    <transition name="fade">
      <p class="value">
        <span class="number">{{ data.altitude + "m" }}</span>
        <span class="tag tag--altitude">Altitudine</span>
      </p>
    </transition>
  </div>
</template>
