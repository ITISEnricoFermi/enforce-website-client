...
<section class="section-targets">
  <div class="bg-video">
    <video class="bg-video__content" autoplay muted loop>
        <source src="/static/videos/lancio.mp4" type="video/mp4">
        <!-- <source src="img/video.webm" type="video/webm"> -->
          Il tuo browser non è supportato!
      </video>
  </div>
  <div class="content">
    <h1 class="heading-primary u-margin-bottom-big">Our targets</h1>
    <div class="targets">
      <div class="target">
        <i class="fas fa-tachometer-alt"></i>
        <h3 class="heading-tertiary u-margin-bottom-small">Mission Control Panel</h3>
        <p class="target__text">
          Control panel for manual control of the probe and real time analisys of all the captured data.
        </p>
      </div>
      <div class="target">
        <i class="fas fa-chart-area"></i>
        <h3 class="heading-tertiary u-margin-bottom-small">Live broadcast</h3>
        <p class="target__text">
          Live broadcast of all the data collected by the probe on our website.
        </p>
      </div>
      <div class="target">
